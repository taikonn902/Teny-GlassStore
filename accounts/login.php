            ...
            <div class="login-form-right">
                <form id="loginForm" method="POST" class="login-form">
                    ...
                    <div class="form-group">
                        <input type="text" id="username" name="user_name" required placeholder=" " autocomplete="username">
                        <label for="username">Tài Khoản</label>
                    </div>
                    <div class="form-group form-group-last">
                        <input type="password" id="password" name="pass_word" required placeholder=" " autocomplete="current-password">
